...
SPRING_Y = 1000
MOTION_DAMP = 0.7  # Damp velocities each step to reduce jitter

trainer = InvPhyTrainerWarp(
    data_path='data/so101_cloth/trajectory_01/final_data.pkl',
    base_dir='./temp_experiments/trajectory_01_v5b',
...
print(f'Spring Y override: {SPRING_Y}, motion damp: {MOTION_DAMP}')
...
out_dir = 'experiments/trajectory_01/dual_gripper_v5b'
